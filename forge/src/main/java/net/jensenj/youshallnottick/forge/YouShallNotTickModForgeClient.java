...
public class YouShallNotTickModForgeClient {
    ...
    @SubscribeEvent
    public static void onPlayerDisconnect(ClientPlayerNetworkEvent.LoggedOutEvent e){
        TickingTotemBlockEntity.TICKING_TOTEM_LOCATIONS.clear();
    }

    @SubscribeEvent
    public static void onPlayerConnect(ClientPlayerNetworkEvent.LoggedInEvent e){
